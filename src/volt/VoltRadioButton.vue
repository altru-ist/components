...
const theme = ref<RadioButtonPassThroughOptions>({
  ...
  box: `flex justify-center items-center rounded-full
        ...
        p-checked:border-[var(--cui-button-primary-rest)] p-checked:bg-[var(--cui-button-primary-rest)]
        peer-enabled:peer-hover:p-checked:bg-[var(--cui-button-primary-hover)] peer-enabled:peer-hover:p-checked:border-[var(--cui-button-primary-hover)]
